...
public class Locadora {
	public static void main(String[] args) {
		...
		c1.adicionaLocacao(new Locacao(new Automovel("Toyota Corolla xEi", 2021, "PLN0525", Classificacao.LUXO), 10));
		c1.adicionaLocacao(new Locacao(new Automovel("Fiat Mobi", 2021, "JPA2464", Classificacao.BASICO), 2));
		c1.adicionaLocacao(new Locacao(new Automovel("BMW Série 7", 2022, "UBA0808", Classificacao.LUXO), 30));
